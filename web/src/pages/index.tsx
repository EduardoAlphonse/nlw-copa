    ...
    <div className="max-w-[1124px] h-screen mx-auto grid grid-cols-2 items-center gap-28">
      <main>
        ...
        <form onSubmit={createPool} className="mt-10 flex gap-2">
          <input
            className="flex-1 px-4 py-6 rounded bg-gray-800 border border-gray-600 text-sm text-gray-100"
            type="text"
            required
          ...
          />
          <button
            className="bg-yellow-500 px-4 py-6 rounded text-gray-900 text-sm font-bold uppercase hover:bg-yellow-700"
            type="submit"
          >
            Criar meu bolão
          </button>
        ...
        <div className="mt-10 pt-10 border-t border-gray-600 divide-x divide-gray-600 flex text-gray-100">
          <div className="flex flex-1 gap-6 pr-14">
          ...
          <div className="flex flex-1 gap-6 pl-14">
            <Image src={iconCheckImg} alt="" />
            <div className="flex flex-col">
              <span className="text-2xl font-bold leading-snug">
                +{props.guessCount}
